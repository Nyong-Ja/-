// 파스모포비아 전체 30종 유령 데이터베이스 (공식 위키 기준)
const GHOSTS = [
    {
        name: "스피릿 (Spirit)",
    ...
    },
    {
        ...
        sanity: "50%",
        tip: "플레이어를 포착하면 시야에서 엄청난 속도로 추격하지만, 놓치면 매우 느려집니다."
    },
    {
        name: "셰이드 (Shade)",
    ...
    },
    {
        ...
        sanity: "50%",
        tip: "전원(두꺼비집)이 꺼져 차가운 방일수록 이동 속도가 빨라지고 입김을 내뿜습니다."
    },
    {
        name: "고료 (Goryo)",
    ...
    },
    {
        ...
        evidence: ["EMF 5", "고스트 오브", "DOTS"],
        sanity: "전자장비 근처 65%",
        tip: "켜진 전자장비 근처에서 이동 속도가 매우 빨라지고 헌팅 기준이 높아집니다."
    },
    {
        name: "오바케 (Obake)",
    ...
    },
    {
        ...
        sanity: "50%",
        tip: "본체와 분신이 각각 다른 위치에서 동시 상호작용을 일으키며, 헌팅 시 속도가 다릅니다."
    },
    {
        name: "미믹 (The Mimic)",
    ...
    },
    {
        ...
        sanity: "50%",
        tip: "스피릿 박스나 주파수로 소리를 들은 플레이어에게 저주를 걸어 정신력을 빠르게 깎습니다."
    },
    {
        name: "데오겐 (Deogen)",
        evidence: ["스피릿 박스", "고스트 라이팅", "DOTS"],
        sanity: "40%",
        tip: "숨어도 플레이어 위치를 타겟팅하며, 가까워지면 속도가 극도로 느려집니다. (스피릿 박스 중저음 특수 숨소리)"
    },
    {
        name: "타예 (Thaye)",
        evidence: ["고스트 오브", "고스트 라이팅", "DOTS"],
        sanity: "초기 75% ~ 나중 15%",
        tip: "처음에는 매우 빠르고 공격적이지만, 플레이어가 근처에 오래 머물수록 나이를 먹어 느려지고 둔해집니다."
    },
    {
        name: "아스왕 (Aswang)",
    ...
    },
    {
        ...
        sanity: "50%",
        tip: "특정 조건에서 공격성이 급격히 변하는 특징을 가집니다."
    },
    {
